...
import type { CustomerDiscountFilters } from "../types";

interface Props {
    filters: CustomerDiscountFilters;
    onFilterChange: <K extends keyof CustomerDiscountFilters>(
        key: K,
...
export function CustomerDiscountFilters({
    filters,
    onFilterChange,
    onReset,
    loading,
